...
- (instancetype)init {
    if (self = [super init]) {
        ...
        _devicePlatform = @"OSX";//[currentDevice systemName] ? [currentDevice systemName] : AWSClientContextUnknown;
        _deviceModel = @"MAC";//[currentDevice model] ? [currentDevice model] : AWSClientContextUnknown;
        _deviceModelVersion = [self deviceModelVersionCode] ? [self deviceModelVersionCode] : AWSClientContextUnknown;
        _devicePlatformVersion = @"OSX";//[currentDevice systemVersion] ? [currentDevice systemVersion] : AWSClientContextUnknown;
